...
NAVBAR_ELEMENTOS_INTERIOR = "pr-14 w-full"
...
# BODY STYLES
# ==========================================
BODY = "flex-1 w-full relative z-10"
GRID_3_COLS = "grid grid-cols-3 w-full"
COL_SPAN_1 = "col-span-1 flex h-full items-center justify-center"
COL_SPAN_2 = "col-span-2 flex h-full items-center justify-center"


# ==========================================
# HOME - PRESENTACION STYLES
# ==========================================
BODY_HOME_PRESENTACION_BASE = "h-[450px] w-[650px] mr-0"
...
BODY_HOME_PRESENTACION_TEXTO_SALUDO = "h-[170px] w-[400px] flex flex-col justify-end items-start pb-1 pl-5 text-2xl text-davs-color-blanco"
BODY_HOME_PRESENTACION_TEXTO_MI_NOMBRE = "h-[80px] w-[400px] flex flex-col justify-start items-start pt-0 pl-5 text-3xl font-bold text-davs-color-blanco"
BODY_HOME_PRESENTACION_TEXTO_CARGO = "h-auto w-[650px] mt-6 mb-4 text-davs-color-cian font-semibold tracking-widest text-base"
BODY_HOME_PRESENTACION_TEXTO_BIOGRAFIA = "h-auto w-[650px] flex flex-col justify-start items-start pb-3 pl-2 text-base text-davs-color-morado-claro"
BODY_HOME_PRESENTACION_FOTO = (
    "w-full h-full object-cover "
    "scale-[1.3]"                
)
# BODY SECCION PROYECTOS
BODY_HOME_PROYECTOS_BASE = "h-[650px] w-[250px] mr-50 flex flex-col justify-start items-start pt-10"
...
PROYECTOS_CARD_BASE_TITULO_CONTENEDOR = "w-full h-[50px] bg-davs-color-base px-6 flex flex-row items-center border-b border-davs-color-cian"
PROYECTOS_CARD_TITULO_TEXTO = "w-[80%] h-full flex items-center font-bold text-davs-color-morado-oscuro text-2xl"
PROYECTOS_CARD_TITULO_ICONOS = "w-[20%] h-full flex items-center justify-end gap-4"
PROYECTOS_CARD_BASE_DESCRIPCION_CONTENEDOR = "w-full flex-1 flex flex-row"
PROYECTOS_CARD_DESC_TEXTO = "w-[60%] h-full p-6 flex flex-col justify-start"
PROYECTOS_CARD_DESC_IMG_CAJA = "w-[40%] h-full p-6 flex justify-center items-center"
...
EXPERIENCIA_CARD_HEADER_BASE = "w-full h-auto min-h-[70px] bg-davs-color-base px-6 py-4 flex flex-row items-center border-b border-davs-color-cian"
EXPERIENCIA_CARD_HEADER_TITULO_BOX = "w-[80%] h-auto flex flex-col justify-center"
EXPERIENCIA_CARD_HEADER_TITULO_TEXT = "text-white font-bold"
EXPERIENCIA_CARD_HEADER_SUBTITULO_TEXT = "text-[#00D1B3] text-sm"
EXPERIENCIA_CARD_HEADER_FECHA_BOX = "w-[25%] h-auto flex flex-col items-center justify-center"
EXPERIENCIA_CARD_HEADER_FECHA_TEXT = "text-white text-sm"
# ==== EXPERIENCIA CARD - BODY 
EXPERIENCIA_CARD_BODY_BASE = "w-full flex-1 flex flex-row"
EXPERIENCIA_CARD_BODY_DESCRIPCION_BOX = "w-[60%] h-auto p-6 pb-8 flex flex-col justify-start"
EXPERIENCIA_CARD_BODY_DESCRIPCION_LISTA = "list-disc ml-6 space-y-2"
EXPERIENCIA_CARD_BODY_DESCRIPCION_IMG_BOX = "w-[40%] h-full p-4 flex justify-center items-center"
...
ESTUDIOS_BODY_BASE = "w-full min-h-screen py-12 px-8 md:px-24 flex flex-col gap-8 items-center"
ESTUDIOS_CARD_BASE = (
...
ESTUDIOS_CARD_HEADER_GRUPO_TITULO = "w-[80%] h-full flex items-center"
...
ESTUDIOS_CARD_ROW_LINK_CERT_ICON = "gray.300"


# ==========================================
# CONTACTO STYLES
# ==========================================
CONTACTO_BODY_BASE = "w-full min-h-screen py-12 px-8 md:px-24 flex flex-col gap-8 items-center"
CONTACTO_CARD_BASE = (
